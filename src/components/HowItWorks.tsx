...
import { PenTool, Code2, Headphones } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="w-24 h-24 rounded-full glass-panel-dark flex items-center justify-center mb-6 relative border border-white/10">
